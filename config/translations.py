TRANSLATIONS = {
    "en": {
        ...
        "num_rounds": "Number of full rounds (each round: C1, Audience, C2, Audience)",
        "roast_mode": "Roast Mode",
        "voice_mode": "Voice Mode (TTS)",
    ...
    "pl": {
        ...
        "num_rounds": "Liczba pełnych rund (każda runda: K1, Publiczność, K2, Publiczność)",
        "roast_mode": "Tryb Roast",
        "voice_mode": "Tryb Głosu (TTS)",
