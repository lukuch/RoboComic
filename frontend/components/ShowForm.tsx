          ...
          <div className="relative">
            <div className="flex items-center bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50/30 dark:from-slate-800/50 dark:via-blue-900/20 dark:to-indigo-900/10 border border-slate-200/60 dark:border-slate-600/40 rounded-3xl shadow-xl shadow-blue-500/10 dark:shadow-blue-500/5 overflow-hidden backdrop-blur-sm">
              <button
                ...
                className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300 dark:from-slate-700 dark:to-slate-600 dark:hover:from-slate-600 dark:hover:to-slate-500 text-slate-600 dark:text-slate-300 font-semibold text-lg transition-all duration-300 ease-out hover:scale-105 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 rounded-r-2xl"
              ...
              <button
                type="button"
                onClick={() => setNumRounds(Math.min(10, numRounds + 1))}
                className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300 dark:from-slate-700 dark:to-slate-600 dark:hover:from-slate-600 dark:hover:to-slate-500 text-slate-600 dark:text-slate-300 font-semibold text-lg transition-all duration-300 ease-out hover:scale-105 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 rounded-l-2xl"
