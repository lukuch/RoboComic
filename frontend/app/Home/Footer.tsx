...
export default function Footer() {
  return (
    <footer className="w-full mt-12 py-2 px-4 bg-white/90 dark:bg-gray-900/90 border-t border-gray-200 dark:border-gray-800 shadow-inner flex flex-col sm:flex-row items-center justify-between gap-2 rounded-t-2xl text-gray-700 dark:text-gray-300 text-sm">
