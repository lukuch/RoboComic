export const TRANSLATIONS = {
  en: {
    ...
    temperatureHelp: 'Temperature controls how creative and unpredictable the AI responses are. Lower values (0.0-0.5) produce more focused, consistent responses. Higher values (0.7-1.0) create more creative, varied, and sometimes unexpected content.',
    errorPresets: 'Failed to load AI presets. Please try again later.',
    noPresets: 'No AI presets available. Please contact support or try again later.',
  ...
  pl: {
    ...
    temperatureHelp: 'Temperatura kontroluje, jak kreatywne i nieprzewidywalne są odpowiedzi AI. Niższe wartości (0.0-0.5) dają bardziej spójne, przewidywalne odpowiedzi. Wyższe wartości (0.7-1.0) generują bardziej kreatywne, zróżnicowane i czasem nieoczekiwane treści.',
    errorPresets: 'Nie udało się załadować ustawień AI. Spróbuj ponownie później.',
    noPresets: 'Brak dostępnych ustawień AI. Skontaktuj się z pomocą techniczną lub spróbuj ponownie później.',
